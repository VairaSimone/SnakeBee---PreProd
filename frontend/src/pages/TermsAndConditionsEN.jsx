  ...
  return (
    <div className="terms-container">
      ...
      <header className="terms-header">
        ...
        <p className="last-updated">Last updated: August 26, 2025</p>
      </header>
      ...
      <section>
        ...
        <p><strong>Digital Services Act (DSA):</strong> In accordance with the DSA (Regulation (EU) 2022/2065), we provide users with reporting mechanisms for illegal content. You can report such content through the appropriate tool on the Platform. We are committed to reviewing reports in a timely manner and taking necessary action.</p>
      </section>
      ...
      <section>
        ...
        <p>
          The processing of users' personal data is governed by our Privacy Policy, available at the following <a href="/privacy-policy" target="_blank" rel="noopener noreferrer">[Privacy Policy link]</a>. By using the Service, you consent to the processing of your personal data as described in that policy.
        </p>
      </section>
