    ...
    <section className="py-20 bg-gradient-to-b from-white to-amber-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          {/* Lato Testo e Logo */}
          <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start">            <img
            src={MarketLogo}
            alt="Snakebee Market"
            ...
            <p className="text-gray-600 text-lg md:text-xl mb-10 leading-relaxed max-w-lg">              {t('market.promo_subtitle')}
            </p>
            <a
              href={MARKET_URL}
              target="_blank"
          ...
          {/* Lato Cards Kit */}
          <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-5">            {previewKits.map((kit) => (
            <div
              key={kit.id}
